...
<html>
    ...
    <body>
        <section>
            <div class="jumbotron">
                <div class="container">
                    <h1>Joc de plataformes</h1>
                    <p>Afegir joc de plataformes</p>
                </div>
            </div>
        </section>
        <section class="container">
            <form:form modelAttribute="newPlataformes" class="form-horizontal">
                <fieldset>
                    <legend>Afegir joc de plataformes</legend>
